<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="min-w-max">
                <a href="{{route('dashboard-location.create')}}" class="fullwidth-btn">Yeni Konum Ekle</a>
            </div>
        </div>
                        ...
                        @foreach($locations as $location)
                            <tr>
                                ...
                                <td class="border px-4 py-2 text-center">
                                    <a class="bg-blue-500 text-white px-4 py-2 text-xs rounded" href="{{route('dashboard-location.edit', $location->id)}}">Düzenlemek</a>
                                    <a class="bg-green-500 text-white px-4 py-2 text-xs rounded" href="{{route('single-location', $location->id)}}" target="_blank">görüş</a>
